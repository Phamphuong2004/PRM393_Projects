                ...
                return ListView(
                  ...
                  children: authState.isAdmin
                      ? [
                          ...
                          _buildSideMenuItem(context, 'Trend Analysis', Icons.insights_outlined, Icons.insights_rounded, '/app/analytics', location),
                ...
                return ListView(
                  ...
                  children: [
                    if (authState.isAdmin) ...[
                      ...
                      _buildDrawerItem(context, icon: Icons.insights_rounded, activeIcon: Icons.insights_rounded, title: 'Trend Analysis', path: '/app/analytics'),
